...
$(function(){
    ...
    $("#three").addClass("round-active");
    $("#three_line").addClass("line-active");
    $("#three_text").addClass("content-active");
    $("#html_title").text("订单支付");
    init();
...
function init() {
    var height = window.innerHeight - $("#div_navbar").height() - $("#div_cart_top").height() - $(".div_footer_bottom").parent().height() - 1;
